  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-white`}>
      ...
      <View style={tw`overflow-hidden mt-2`}>
        <View
          style={[tw`flex-row w-full h-16 items-center justify-between px-4`]}
        >
          <TouchableOpacity
      ...
      <View style={tw`flex p-2`}>
        <View style={tw`flex-row items-center justify-center`}>
          ...
          <SalesCard
            ...
            containerStyle={{ backgroundColor: "#ff8552" }}
            iconStyle="white"
            amountStyle={tw`text-white`}
          />
          <SalesCard
            label="Commission"
            icon="info"
        ...
        <View style={tw`flex-row items-center justify-center`}>
          ...
          <SalesCard
            ...
            amount={"GHS " + gross}
            labelStyle={tw`text-white`}
            containerStyle={tw`bg-green-400`}
            iconStyle="white"
            amountStyle={tw`text-white`}
          />
          <SalesCard
            ...
            amount={"GHS " + net}
            labelStyle={tw`text-white`}
            containerStyle={tw`bg-purple-400`}
            iconStyle="white"
            amountStyle={tw`text-white`}
          />
        </View>
        <View style={tw`flex-row items-center justify-center`}>
          ...
          <SalesCard
            ...
            amount={"GHS " + amount}
            labelStyle={tw`text-white`}
            containerStyle={tw`bg-yellow-400`}
            iconStyle="white"
            amountStyle={tw`text-white`}
          />
        </View>
