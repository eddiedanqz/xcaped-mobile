  ...
  return (
    <View style={tw`flex-1 bg-white`}>
      <View style={[tw` flex-1 justify-center items-center mt-6`]}>
        <Image source={bgImage} style={tw`w-full h-full`} blurRadius={10} />

        <View style={[tw` w-full  shadow-lg py-2 px-3 absolute`]}>
          <View
            style={tw`bg-white justify-center items-center rounded-lg px-1`}
          >
            {/**Top Card */}
            ...
            <TextButton
              ...
              buttonContainerStyle={[
                tw`bg-transparent rounded-lg p-3 w-48 mb-2`,
              ]}
