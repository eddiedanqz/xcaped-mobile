...
const Validator = ({data,isVisible,viewStyle,messageStyle,onPress}) => {
  ...
  return (
    <TouchableOpacity style={[tw`absolute top-16 right-2 z-10`,viewStyle]} onPress={onPress}>
    {data.errors ?
  ...
  rounded z-30 mb-2 shadow-xl`}>
    ...
    <View
    style={[tw`flex flex-row justify-center items-center bg-yellow-400 z-10 p-2
  rounded z-20 mb-2 shadow`,messageStyle]}>
